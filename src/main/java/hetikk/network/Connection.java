...
public final class Connection {
     ...
     */
    public static String getRequestResponse(String urlString) throws IOException {
        ...
        BufferedReader in = new BufferedReader(new InputStreamReader(conn.getInputStream(), Charset.defaultCharset()));
        String inputLine;
